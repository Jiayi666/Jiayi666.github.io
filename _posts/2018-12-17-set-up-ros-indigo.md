...
[Here](https://answers.ros.org/question/57213/how-i-completely-remove-all-ros-from-my-system/) is the instruction. Must remove ROS clearly before you start to compile everything again. The remaining from old version can hard a lot.
